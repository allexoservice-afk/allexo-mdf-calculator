...
<pattern id="glassHatch" width="9" height="9" patternUnits="userSpaceOnUse" patternTransform="rotate(-45)">
<line x1="0" y1="0" x2="0" y2="9" stroke="#1e2a33" stroke-width="0.65" stroke-opacity="0.18"/>
</pattern>
</defs>`

/** @param {number} x @param {number} y @param {number} w @param {number} h */
function glassRect(x, y, w, h) {
  return `<rect x="${x}" y="${y}" width="${w}" height="${h}" fill="url(#glassShine)"/>
<rect x="${x}" y="${y}" width="${w}" height="${h}" fill="url(#glassHatch)"/>
 ...
 * @param {string} [frameFill] Колір рамки/відкосів (MDF — дерево, PVC — білий)
 * @returns {string}
 */
export function typeVisualInnerMarkup(variant, frameFill = MDF_FRAME) {
  const F = frameFill
  switch (variant) {
    case 'no-sill':
...
${glassRect(38, 24, 40, 40)}
<line x1="58" y1="24" x2="58" y2="64" stroke="${STROKE}" stroke-width="0.9" opacity="0.4"/>`
...
<line x1="26" y1="7.5" x2="90" y2="7.5" stroke="${STROKE}" stroke-width="0.6" opacity="0.4"/>
<line x1="26" y1="11" x2="90" y2="11" stroke="${STROKE}" stroke-width="0.6" opacity="0.4"/>
<line x1="26" y1="14.5" x2="90" y2="14.5" stroke="${STROKE}" stroke-width="0.6" opacity="0.4"/>
...
${glassRect(38, 18, 40, 40)}
<line x1="58" y1="18" x2="58" y2="58" stroke="${STROKE}" stroke-width="0.9" opacity="0.4"/>`
...
<line x1="26" y1="11.5" x2="90" y2="11.5" stroke="${STROKE}" stroke-width="0.6" opacity="0.4"/>
<line x1="26" y1="15" x2="90" y2="15" stroke="${STROKE}" stroke-width="0.6" opacity="0.4"/>
<line x1="26" y1="18.5" x2="90" y2="18.5" stroke="${STROKE}" stroke-width="0.6" opacity="0.4"/>
${glassRect(38, 22, 40, 40)}
<line x1="58" y1="22" x2="58" y2="62" stroke="${STROKE}" stroke-width="0.9" opacity="0.4"/>`

    case 'sill-only':
      return `${glassRect(38, 22, 40, 40)}
<line x1="58" y1="22" x2="58" y2="62" stroke="${STROKE}" stroke-width="0.9" opacity="0.4"/>
<rect x="34" y="62" width="48" height="2" fill="${SILL}" stroke="${STROKE}" stroke-width="1"/>`

    default:
      return `${glassRect(38, 24, 40, 40)}
<line x1="58" y1="24" x2="58" y2="64" stroke="${STROKE}" stroke-width="0.9" opacity="0.4"/>`
  }
}
...
export function buildTypeVisualSvg(variant, opts = {}) {
  ...
  const frameFill = opts.frameFill || MDF_FRAME
