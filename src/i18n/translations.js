...
export const TRANSLATIONS = {
  uk: {
    ...
    form: {
      ...
      addSameType: '+ Додати ще вікно (той самий тип)',
      addOtherType: 'Інший тип робіт',
      cancel: 'Скасувати',
  ...
  en: {
    ...
    form: {
      ...
      addSameType: '+ Add another window (same type)',
      addOtherType: 'Other work type',
      cancel: 'Cancel',
  ...
  nl: {
    ...
    form: {
      ...
      addSameType: '+ Nog een raam toevoegen (zelfde type)',
      addOtherType: 'Ander type werk',
      cancel: 'Annuleren',
  ...
  fr: {
    ...
    form: {
      ...
      addSameType: '+ Ajouter une autre fenêtre (même type)',
      addOtherType: 'Autre type de travaux',
      cancel: 'Annuler',
